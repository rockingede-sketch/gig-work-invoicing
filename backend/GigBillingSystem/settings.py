"""
Django settings for GigBillingSystem project.
...
SECRET_KEY = 'django-insecure-k4jz%upf&t^#@s)eo86i)(!wq6_gg@c5(^fmbr@0h&q@@4k+rn'
...
ROOT_URLCONF = 'GigBillingSystem.urls'
...
WSGI_APPLICATION = 'GigBillingSystem.wsgi.application'
